 ...
 */
const Floating = ({ children, content, theme, animation = 'duration-300', arrow = true, placement = 'top', style = 'dark', trigger = 'hover', dismissOnClick = true, ...props }) => {
    ...
    const { getFloatingProps, getReferenceProps } = (0, react_dom_interactions_1.useInteractions)([
        ...
        (0, react_dom_interactions_1.useDismiss)(context, { referencePointerDown: true }),
    ]);
    (0, react_1.useEffect)(() => {
